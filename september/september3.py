...
from pygart import Canvas, PaletteRNG, V, month_palette, produce
...
width, height, out, i, unit_size = produce(scale=40, unit_size=20)
...
Tiling(figs, width, unit_size).tile(canvas.img, fname=out)
